...
{				
		...
		RCC_AHB1PeriphClockCmd ( RCC_AHB1Periph_GPIOA, ENABLE); 	/*开启GPIO外设时钟*/
	  RCC_AHB1PeriphClockCmd ( RCC_AHB1Periph_GPIOH, ENABLE); 	/*开启GPIO外设时钟*/
    ...
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
	  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
		...
		GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;	/* 设置引脚为不上拉也不下拉 */
