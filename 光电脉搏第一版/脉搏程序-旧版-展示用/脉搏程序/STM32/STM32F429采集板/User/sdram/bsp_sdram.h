...
#define IS42S16400J_SIZE 0x800000//0x800000  //400000*16bits = 0x800000  ，8M字节 0x4000000
...
#define FMC_A12_GPIO_PORT        GPIOG									//增加的*************
...
//#define FMC_WE_PINSOURCE        GPIO_PinSource0
//#define FMC_WE_AF               GPIO_AF_FMC
#define FMC_WE_GPIO_PORT        GPIOH													//WE 脚用H5
...
void  SDRAM_WriteBuffer(uint16_t* pBuffer, uint16_t uwWriteAddress, uint32_t uwBufferSize);
void  SDRAM_ReadBuffer(uint16_t* pBuffer, uint16_t uwReadAddress, uint32_t uwBufferSize);
